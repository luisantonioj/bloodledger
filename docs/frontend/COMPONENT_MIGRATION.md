...
| Analytics cards, filters, chart, and assessment table | `apps/web/src/features/analytics/` | latest-mockup visual delta | Read-only unavailable-state preview; runtime data contract deferred | role-visibility tests, web build, and explicit simulation disclosure |
