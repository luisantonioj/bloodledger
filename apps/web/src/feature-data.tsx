...
function TransferDetailView({data,close,canReject,canCancel,canCancelApproved,canDispatch,canStartTransit,canReceive,receiptInstitutionId,onDone}:{data:TransferDetail;close:()=>void;canReject:boolean;canCancel:boolean;canCancelApproved:boolean;canDispatch:boolean;canStartTransit:boolean;canReceive:boolean;receiptInstitutionId:string;onDone:()=>void}) {
...
function TransferExplorer({data,canSubmit,canReject,canCancel,canCancelApproved,canDispatch,canStartTransit,canReceive,receiptInstitutionId,onRefresh}:{data:Transfers;canSubmit:boolean;canReject:boolean;canCancel:boolean;canCancelApproved:boolean;canDispatch:boolean;canStartTransit:boolean;canReceive:boolean;receiptInstitutionId:string;onRefresh:()=>void}) {
...
export function FeatureData({path,canAcknowledge=false,canSubmitTransfer=false,canRejectTransfer=false,canCancelTransfer=false,canCancelApprovedTransfer=false,canDispatchTransfer=false,canStartTransit=false,canReceiveTransfer=false,canCapture=false,principal}:{path:string;canAcknowledge?:boolean;canSubmitTransfer?:boolean;canRejectTransfer?:boolean;canCancelTransfer?:boolean;canCancelApprovedTransfer?:boolean;canDispatchTransfer?:boolean;canStartTransit?:boolean;canReceiveTransfer?:boolean;canCapture?:boolean;principal?:ProfilePrincipal}) {
