...
function TransferDetailView({data,close,canReject,canCancel,canCancelApproved,canDispatch,onDone}:{data:TransferDetail;close:()=>void;canReject:boolean;canCancel:boolean;canCancelApproved:boolean;canDispatch:boolean;onDone:()=>void}) {
...
function TransferExplorer({data,canSubmit,canReject,canCancel,canCancelApproved,canDispatch,onRefresh}:{data:Transfers;canSubmit:boolean;canReject:boolean;canCancel:boolean;canCancelApproved:boolean;canDispatch:boolean;onRefresh:()=>void}) {
...
export function FeatureData({path,canAcknowledge=false,canSubmitTransfer=false,canRejectTransfer=false,canCancelTransfer=false,canCancelApprovedTransfer=false,canDispatchTransfer=false,canCapture=false,principal}:{path:string;canAcknowledge?:boolean;canSubmitTransfer?:boolean;canRejectTransfer?:boolean;canCancelTransfer?:boolean;canCancelApprovedTransfer?:boolean;canDispatchTransfer?:boolean;canCapture?:boolean;principal?:ProfilePrincipal}) {
  ...
  if(path==="/transfers")return <TransferExplorer data={state.data as Transfers} canSubmit={canSubmitTransfer} canReject={canRejectTransfer} canCancel={canCancelTransfer} canCancelApproved={canCancelApprovedTransfer} canDispatch={canDispatchTransfer} onRefresh={state.manual}/>;
