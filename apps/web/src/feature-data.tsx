...
function TransferExplorer({data,canSubmit,canReject,canCancel,canCancelApproved,onRefresh}:{data:Transfers;canSubmit:boolean;canReject:boolean;canCancel:boolean;canCancelApproved:boolean;onRefresh:()=>void}) {
...
export function FeatureData({path,canAcknowledge=false,canSubmitTransfer=false,canRejectTransfer=false,canCancelTransfer=false,canCancelApprovedTransfer=false,canCapture=false,principal}:{path:string;canAcknowledge?:boolean;canSubmitTransfer?:boolean;canRejectTransfer?:boolean;canCancelTransfer?:boolean;canCancelApprovedTransfer?:boolean;canCapture?:boolean;principal?:ProfilePrincipal}) {
  ...
  if(path==="/transfers")return <TransferExplorer data={state.data as Transfers} canSubmit={canSubmitTransfer} canReject={canRejectTransfer} canCancel={canCancelTransfer} canCancelApproved={canCancelApprovedTransfer} onRefresh={state.manual}/>;
