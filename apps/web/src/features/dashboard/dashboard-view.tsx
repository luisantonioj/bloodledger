...
export function DashboardView({data,canCapture,refreshError,onRetry}:{data:Dashboard;canCapture:boolean;refreshError:string;onRetry:()=>void}) {
  if(data.composition==="ADMINISTRATIVE")return <div className="empty"><strong>Non-clinical workspace</strong>This account has no inventory, custody, transfer, or regulatory dashboard authority.</div>;
